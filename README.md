...
This app uses Vite `base: "./"` so built assets are referenced relatively (`./assets/...`), which avoids GitHub Pages project-site path issues (including `/SunnySunshine/` deployments).
